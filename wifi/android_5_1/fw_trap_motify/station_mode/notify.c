			       ...
			       enum wpa_states old_state)
{
	...
	sme_state_changed(wpa_s);
...
#ifdef ANDROID
        wpa_printf(MSG_INFO, "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n");
        wpa_printf(MSG_INFO, "wpas_notify_state_changed\n");
        wpa_printf(MSG_INFO, "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n");
        wpa_printf(MSG_INFO, "id=%d state=%d BSSID=" MACSTR " SSID=%s\n",  
        ...
        wpa_printf(MSG_INFO, "ballack\n");

        if(new_state == WPA_INTERFACE_DISABLED) {
